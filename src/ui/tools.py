...
class ToolsMenu(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        #Set their icons
        select_button.setIcon(QIcon("C:/Users/Julian/projects/python/mediaPlayer/src/ui/icons/select.png"))  # Replace with your clear icon file
        annotation_button.setIcon(QIcon("C:/Users/Julian/projects/python/mediaPlayer/src/ui/icons/brush.png"))    # Replace with your undo icon file
